...
class CreateWindow(qtw.QWidget, Ui_createUpdate):
    ...
    def __init__(self):
        ...
        self.uic.le_description.setPlaceholderText("enter a description")
    ...
    def btn_submit_create(self):
        ...
        description = self.uic.le_description.text()
        ...
        SqlDataConnection.create_new_device(self, hostname, ipaddress, username, password, location, description)
...
class UpdateWindow(qtw.QWidget, Ui_createUpdate):
    ...
    def __init__(self, id, hostname, ipaddress, username, password, location, description):
        ...
        self.uiu.le_hostname.setPlaceholderText(hostname)
        self.uiu.le_ipaddress.setPlaceholderText(ipaddress)
        self.uiu.le_username.setPlaceholderText(username)
        self.uiu.le_password.setPlaceholderText(password)
        self.uiu.le_location.setPlaceholderText(location)
        self.uiu.le_description.setPlaceholderText(description)
        ...
        #self.uiu.btn_submit.clicked.connect(lambda : self.btn_submit_update(id, input_hostname, input_ipaddress, input_username, input_password, input_location, input_description))
    ...
    def btn_submit_update(self, id):
        ...
        print(f"input_description = {new_description}")

        # SQL UPDATE | Send message to reset the viewtable | Close the UPDATE window
        SqlDataConnection.update_device(self, new_hostname, new_ipaddress, new_username, new_password, new_location, new_description, id)
